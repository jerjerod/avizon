                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @endif
                                    <div class="col-lg-3">
                                        {!! link_to_route('admin.user.edit','modifier', [$user->id],['class' => 'btn btn-success btn-block btn']) !!}
                                    </div>
                                </div>
                                <!-- /.col-lg-6 (nested) -->
                                <div class="col-lg-6">
                                    ...
                                    <div class="dataTable_wrapper">
                                        <table class="table table-striped table-hover" >
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{!! link_to_route('admin.module.show',$authorization->module->name, [$authorization->module_id]) !!}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        {!! link_to_route('admin.perimeter.show',$perimeter->nom_com, [$perimeter->id]) !!}
                                                        @endforeach
                                                        </ul>
                                                    </td>
                                                </tr>
